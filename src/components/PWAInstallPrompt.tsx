  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-black/80 border border-white/40 shadow-2xl rounded-2xl p-4 flex items-center gap-4 relative overflow-hidden group">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white truncate">Use L & P Trading and Services as an app</p>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <button 
                ...
                className="text-[10px] text-white font-bold hover:text-white text-center uppercase tracking-wider"
              >
                Not now
              </button>
            </div>
