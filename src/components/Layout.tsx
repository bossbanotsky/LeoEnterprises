...
import { LayoutGrid, UsersRound, Receipt, Clock, Settings2, WalletCards, Pickaxe, LogOut, Megaphone, MessageSquare, GalleryHorizontal, FileText, Briefcase, Wallet } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          const getModuleColor = (label: string) => {
            switch(label.toLowerCase()) {
              ...
              case 'finance': return 'from-blue-400 to-indigo-600';
