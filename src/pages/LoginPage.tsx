            ...
            <Link to="/">
              <div className="flex items-center gap-2 group cursor-pointer">
                ...
                <div className="flex flex-col">
                  <span className="font-black text-sm tracking-tight text-white uppercase italic leading-none">L & P <span className="text-blue-500">TRADING AND SERVICES</span></span>
